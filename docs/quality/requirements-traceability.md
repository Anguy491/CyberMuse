...
| FR-013 | Audio scoring；Data metrics；Signal UI feedback semantics；ADR-012 | TC-SCO-001 cents/等级/滞回；TC-FBK-001 轻松模式独立呈现 | M3/M10 | `packages/scoring/src/scoring.test.ts`、`PracticePage.test.tsx`、`ReviewPage.test.tsx`；评分边界保持 M3，呈现层见 [M10 evidence](../delivery/evidence/m10-ux-closeout.md) |
...
| NFR-017 | Accessible feedback；Signal UI dual-theme contrast/focus/motion/font fallback | TC-A11Y-001 dark/light/键盘/灰度/forced-colors/焦点/reduced-motion/断网字体回退；TC-FBK/NAV-001 | M1/M3/M6/M10 | `signal-ui.test.ts`、Practice/Review/App page tests；M10 校准刻度、轻松文案和完整导航见 [M10 evidence](../delivery/evidence/m10-ux-closeout.md) |
...
| NFR-023 | ADR-023；Pitch Lane index/LOD；M10 calibration ticks；三层音高真值 | TC-PERF-005 4 ms P95/30–60 FPS；TC-PIT-002 三层精度；TC-PLV3-001 | M8/M10 | 自动坐标/降采样/刻度间距与性能证据；合法 vocal-stem、校准硬件回环和发布显示矩阵仍按 [M8 evidence](../delivery/evidence/m8-pitch-lane-v2.md) 开放；M10 呈现见 [M10 evidence](../delivery/evidence/m10-ux-closeout.md) |
...
- FR-013/018/027/029 与 NFR-017/023 的实现、自动命令和剩余人工显示矩阵统一记录在 [M10 UI and Navigation Closeout Evidence](../delivery/evidence/m10-ux-closeout.md)。M10 不修改 scoring package、session schema、Tauri/API、AudioWorklet/Worker 或 analyzer；若验证发现这些边界有差异，M10 立即停止申请门禁。
